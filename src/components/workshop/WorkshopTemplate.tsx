...
const renderPaper = (paper: WorkshopPaper) => (
  <div key={paper.title} className={style.paperCard}>
...
const WorkshopTemplate = ({ data }: { data: WorkshopData }) => (
  <>
    {data.banner ? (
      <img className={style.banner} src={data.banner} alt={data.title} />
    ) : null}
    ...
    <Section title="Overview">
      ...
      {data.overviewHighlights && data.overviewHighlights.length ? (
        <ul className={style.highlightList}>
          {data.overviewHighlights.map(highlight => (
      ...
      {data.overviewClosing ? <p>{data.overviewClosing}</p> : null}
    </Section>
    ...
    {data.agenda && data.agenda.length ? (
      <Section title="Schedule">
        {data.agendaNote ? (
          <p className={style.subtitle}>{data.agendaNote}</p>
        ) : null}
    ...
    {data.papers && data.papers.length ? (
      <Section title="Selected Papers">
        <div className={style.paperList}>{data.papers.map(renderPaper)}</div>
      </Section>
    ) : null}
